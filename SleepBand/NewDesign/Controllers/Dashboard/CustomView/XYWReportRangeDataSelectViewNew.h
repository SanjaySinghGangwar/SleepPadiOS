//
//  XYWReportRangeDataSelectViewNew.h
//  SleepBand
//
...
@protocol XYWReportRangeDataSelectViewNewDelegate <NSObject>

- (void)XYWReportRangeDataSelectNewViewSelectIndex:(NSInteger)index;

@end

@interface XYWReportRangeDataSelectViewNew : UIView
...
@property (nonatomic, weak) id <XYWReportRangeDataSelectViewNewDelegate> delegate;
